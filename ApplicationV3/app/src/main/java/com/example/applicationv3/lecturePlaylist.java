...
import static com.example.applicationv3.R.drawable.ic_pause;
import static com.example.applicationv3.R.drawable.ic_play_arrow;
                                ...
                                mSpotifyAppRemote.getPlayerApi().getPlayerState().setResultCallback(new CallResult.ResultCallback<PlayerState>() {
                                    ...
                                    public void onResult(PlayerState playerState) {
                                        if (playerState.isPaused){
                                            ...
                                            playimg.setImageDrawable(ResourcesCompat.getDrawable(getResources(), ic_pause,getTheme()));
                                        }else{
                                            mSpotifyAppRemote.getPlayerApi().pause();
                                            playimg.setImageDrawable(ResourcesCompat.getDrawable(getResources(), ic_play_arrow,getTheme()));
                                        }
                                    }
                                });
                            }
